...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createPlayers() {
        player1 = createPlayer(name: "player1", building: buildings[1])
        player2 = createPlayer(name: "player2", building: buildings[buildings.count - 2])
    }
    
    func createPlayer(name: String, building: BuildingNode) -> SKSpriteNode {
